...
const Main = () => {
  ...
  return (
    <div className="flex-1 min-h-screen relative">
      ...
      <div className="max-w-[900px] m-auto mt-[100px] mb-[100px] py-0">
        {!showResult ? (
          <>
            <div className="text-[#202020] mx-0 my-10 p-5 text-4xl sm:text-6xl">
              <p className="mb-2 sm:mb-5">Hey, Friend</p>
              <p>What are you feeling today?</p>
            </div>
            <div className="grid grid-cols-[repeat(auto-fill,minmax(180px,1fr))] gap-5 p-5">
              <div
                className="h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb]"
                onClick={() =>
                  handleCardClick("A Late Night Drive In The Rain")
                }
              >
                <p className="text-[#202020] text-[17px]">
                  A Late Night Drive In The Rain
                </p>
              </div>
              <div
                className="h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb]"
                onClick={() =>
                  handleCardClick("A Romantic Dinner Under the Stars")
                }
              >
                <p className="text-[#202020] text-[17px]">
              ...
              <div
                className="h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb] hidden sm:block"
                onClick={() =>
                  handleCardClick("A Dance Party in My Living Room")
                }
              >
                <p className="text-[#202020] text-[17px]">
              ...
              <div
                className="h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb] hidden sm:block"
                onClick={() =>
                  handleCardClick("An Intense Workout Session with Rap")
                }
              >
                <p className="text-[#202020] text-[17px]">
                  An Intense Workout Session with Rap
                </p>
              </div>
            </div>
            <div>
              <button
                className="pr-5 pb-5 underline underline-offset-2 cursor-pointer float-right hover:opacity-65"
              ...
              {isCardModalOpen && (
                <div
                  className="cardModal-overlay fixed w-full h-full flex justify-center items-center pointer-events-auto z-[1000] left-0 top-0 bg-black/50 "
                  onClick={closeCardModal}
                >
                  <div
                    className={`fixed w-[95vw] max-w-[900px] h-auto max-h-[80vh] overflow-y-scroll p-5 rounded-[20px] bg-white ${
                      isCardModalOpen ? "bottom-auto" : ""
                    }`}
                  ...
                  >
                    ...
                    <div className=" grid grid-cols-[repeat(auto-fill,minmax(180px,1fr))] gap-5 p-5 animate-[fadeIn_1.5s]">
                      <div
                        className="card h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb]"
                        onClick={() =>
                          handleCardClick(
                            "Modern country songs for my cowboy era"
                          )
                        }
                      >
                        <p className="text-[#202020] text-[17px]">
                      ...
                      <div
                        className=" h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb]"
                        onClick={() =>
                          handleCardClick("For a Late-Night Study Session")
                        }
                      >
                        <p className="text-[#202020] text-[17px]">
                      ...
                      <div
                        className=" h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb]"
                        onClick={() =>
                          handleCardClick("Chilling by the Beach with Friends")
                        }
                      >
                        <p className="text-[#202020] text-[17px]">
                          Chilling by the Beach with Friends
                        </p>
                      </div>
                      <div
                        className=" h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb]"
                        onClick={() => handleCardClick("An Epic Road Trip")}
                      >
                        <p className="text-[#202020] text-[17px]">
                          An Epic Road Trip
                        </p>
                      ...
                      <div
                        className=" h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb]"
                        onClick={() =>
                          handleCardClick("Unwinding After a Long Day")
                        }
                      >
                        <p className="text-[#202020] text-[17px]">
                      ...
                      <div
                        className=" h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb]"
                        onClick={() =>
                          handleCardClick("A Nostalgic Trip Down Memory Lane")
                        }
                      >
                        <p className="text-[#202020] text-[17px]">
                      ...
                      <div
                        className=" h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb]"
                        onClick={() =>
                          handleCardClick("Celebrating Life’s Small Wins")
                        }
                      >
                        <p className="text-[#202020] text-[17px]">
                          Celebrating Life’s Small Wins
                        </p>
                      </div>
                      <div
                        className=" h-auto p-[15px] bg-[#f0f4f9] rounded-lg relative cursor-pointer hover:bg-[#e2e6eb]"
                        onClick={() =>
                          handleCardClick("A Cozy Evening by the Fireplace")
                        }
                      >
                        <p className="text-[#202020] text-[17px]">
                ...
                <div className=" flex items-center justify-between gap-5 bg-[#f0f4f9] px-5 py-2 sm:py-2.5 rounded-full ">
                  ...
                  <div className="flex flex-row gap-1">
                    <img
                      id="advanced-options"
                      onClick={() =>
                        toast.info("Advanced Options Available Soon")
                      }
                      className="w-10 sm:w-11 p-2  flex items-center justify-center cursor-pointer hover:opacity-65"
                      src={assets.customize_icon}
                      alt=""
                    />
                    <Tooltip
                      anchorSelect="#advanced-options"
                      content="Advanced Options"
                    />
                    {input ? (
                      <img
                        className="w-10 sm:w-11 p-2 bg-black rounded-full flex items-center justify-center cursor-pointer hover:opacity-65"
                        onClick={() => onSent()}
                        src={assets.send_arrow}
                        alt=""
                      />
                    ) : null}
                  </div>
                  ...
                  <AdvancedOptions
                    ...
                    closeMenu={closeAdvancedOptions}
                  />
                </div>
              ) : (
                <div className=" flex items-center justify-between gap-5 bg-[#f0f4f9] px-5 py-2 sm:py-2.5 rounded-full ">
            ...
            <div className="fixed left-1/2 transform -translate-x-1/2 max-w-[900px] flex flex-col bottom-0 w-full mx-auto my-[15px] px-5 py-0 justify-center items-center">
                <div className=" w-full flex flex-row items-center gap-5 ">
                  ...
                  {isVisible && (
                    <div
                      onClick={regenerate}
                      className="bg-[#f0f4f9] p-2 rounded-full cursor-pointer "
                    >
                      <img
                        id="regenerate"
                      ...
                      />
                      <Tooltip
                        anchorSelect="#regenerate"
                        content="Regenerate Playlist"
                      />
                    </div>
                  )}
                </div>
